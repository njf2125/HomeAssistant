$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-label"] = new basedisplay("default-label", "", "default", {'icons': [], 'namespace': 'default', 'widget_type': 'basedisplay', 'static_css': {'title2_style': 'color: #fff;', 'container_style': '', 'unit_style': '', 'state_text_style': 'color: #fff;', 'value_style': 'color: #fff;', 'widget_style': 'background-color: #444;', 'title_style': 'color: #fff;'}, 'static_icons': [], 'css': {}, 'fields': {'value': 'Hello World', 'unit': '', 'title2': '', 'state_text': '', 'title': ''}})
